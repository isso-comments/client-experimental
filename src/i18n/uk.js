module.exports = {
  ...
  "postbox-email": "Електронна пошта (необов'язково)",
  ...
  "postbox-preview": "Попередній перегляд",
  "postbox-edit": "Редагувати",
  "postbox-submit": "відправляти",
  "postbox-notification": "Підпишіться на повідомлення про відповіді електронною поштою",

  "num-comments": "один коментар\n{{ n }} коментарі\n{{ n }} коментарів",
  "no-comments": "Коментарів поки немає",
  "atom-feed": "Атомний потік",

  "comment-reply": "Відповісти",
  "comment-edit": "Редагувати",
  "comment-save": "Зберегти",
  "comment-delete": "Видалити",
  "comment-confirm": "Підтвердьте",
